...
"""
Execute the searching stage of EarlyBERT on the finetuning task for
...
from transformers.modeling_bert import BertSelfAttention, BertLayer
...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            # Add the L-1 regularization loss to the loss fuction, weighted by
            # `args.l1_loss_coef`.
            if args.l1_loss_coef > 0.0:
                l1_loss = 0.0
                ...
                loss += l1_loss * args.l1_loss_coef
...
def main():
    ...
    # Perform the searching stage in EarlyBERT for both self-attention heads and
    ...
    # Save the trained coefficients in EarlyBERT.
    # Will be used to draw EarlyBERT tickets later.
    if args.do_train:
